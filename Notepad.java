...
{
JOptionPane.showMessageDialog(Notepad.this.f,aboutText,"Developed by M A Hafeez",JOptionPane.INFORMATION_MESSAGE);
}
else
...
final String aboutText=
	"<html><big>Your eXtream Pad</big><hr><hr>"
	+"<p align=right>Developed by M A Hafeez "
	+"<hr><p align=left>I Used Java Language to Developed it<br><br>"
	+"<strong>It's all about you, Thanks for Using it!</strong><br>"
	+"Any Time Welcome to your comments, suggestions or thinking<p align=center>"
	+"<hr><em><bi>arslanhafeez1211@gmail.com</big></em><hr><html>";
}